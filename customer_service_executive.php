...
<body>
    <div class="container form-container">
        ...
        <ul>
            ...
            <li>Resolve customer issues in a timely manner</li>
            <li>Maintain customer records and interactions</li>
            <li>Ensure customer satisfaction and loyalty</li>
        </ul>

        <h2>Average Salary</h2>
        <p>$40,000 - $70,000 per year</p>
        ...
        <ul>
            ...
            <li>Multitasking and patience</li>
            <li>Basic computer skills</li>
        </ul>

        <a href="customer_service_executive_courses.php" class="btn-courses">View Courses</a>
    </div>
