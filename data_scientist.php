...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Button Styling for View Courses */
        .btn-view-courses {
...
<body>
    <div class="container form-container">
        ...
        <ul>
            ...
            <li>Clean and preprocess data for analysis</li>
            <li>Visualize data insights and trends</li>
            <li>Collaborate with teams to implement data-driven solutions</li>
        </ul>

        <h2>Average Salary</h2>
        <p>$90,000 - $160,000 per year</p>
        ...
        <a href="data_scientist_courses.php" class="btn-view-courses">View Courses</a>
    </div>
