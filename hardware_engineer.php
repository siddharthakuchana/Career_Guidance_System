...
<body>
    <div class="container form-container">
        ...
        <ul>
            <li>Design and test computer hardware components</li>
        ...
        <ul>
            ...
            <li>Knowledge of hardware testing tools</li>
        </ul>

        <a href="hardware_engineer_courses.php" class="btn-courses">View Courses</a>
    </div>
