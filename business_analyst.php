...
<body>
    <div class="container form-container">
        ...
        <ul>
            ...
            <li>Collaborate with stakeholders for system improvements</li>
            <li>Document business needs and workflows</li>
            <li>Assist in project planning and implementation</li>
            <li>Evaluate business solutions and strategies</li>
        </ul>
        ...
        <a href="business_analyst_courses.php" class="btn-courses">View Courses</a>
    </div>
