...
<head>
    ...
    <title>Application Support Engineer</title>
...
<body>
    <div class="container form-container">
        <h1>Application Support Engineer</h1>

        <h2>Job Responsibilities</h2>
        <ul>
            <li>Provide technical support for software applications</li>
            <li>Troubleshoot application issues</li>
            <li>Assist users in resolving software-related problems</li>
            <li>Ensure system performance and availability</li>
            <li>Collaborate with developers for bug fixes</li>
        </ul>

        <h2>Average Salary</h2>
        <p>$60,000 - $100,000 per year</p>
        ...
        <a href="application_support_engineer_courses.php" class="btn-courses">View Courses</a>
    </div>
