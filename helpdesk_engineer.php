...
<body>
    <div class="container form-container">
        ...
        <ul>
            ...
            <li>Assist with system upgrades and installations</li>
            <li>Document and track technical issues</li>
        </ul>

        <h2>Average Salary</h2>
        <p>$45,000 - $80,000 per year</p>
        ...
        <ul>
            ...
            <li>IT support ticketing systems</li>
        </ul>

        <a href="helpdesk_engineer_courses.php" class="btn-courses">View Courses</a>
    </div>
