...
<body>
    <div class="container form-container">
        ...
        <ul>
            <li>Plan and oversee IT projects</li>
            <li>Manage project timelines and budgets</li>
            <li>Coordinate with teams and stakeholders</li>
            <li>Monitor project progress and resolve issues</li>
            <li>Ensure successful project delivery</li>
        </ul>

        <h2>Average Salary</h2>
        <p>$80,000 - $140,000 per year</p>

        <h2>Required Skills</h2>
        <ul>
            <li>Project management methodologies (Agile, Scrum)</li>
        ...
        <a href="project_manager_courses.php" class="btn-courses">View Courses</a>
    </div>
