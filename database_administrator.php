...
<body>
    <div class="container form-container">
        ...
        <a href="database_administrator_courses.php" class="btn-view-courses">View Courses</a>
    </div>
