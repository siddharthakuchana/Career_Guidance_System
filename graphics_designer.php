    ...
    <style>
        ...
        * {
        ...
        .btn-logout:focus {
            ...
            outline-offset: {{--Code truncated for brevity, continuing from the previous section--}}
...
<body>
    <div class="container form-container">
        ...
        <ul>
            <li>Create visual content for digital and print media</li>
            <li>Design logos, advertisements, and marketing materials</li>
            <li>Use design software to create graphics</li>
            <li>Work with clients to meet their design needs</li>
            <li>Stay updated with design trends and tools</li>
        </ul>

        <h2>Average Salary</h2>
        <p>$50,000 - $90,000 per year</p>

        <h2>Required Skills</h2>
        <ul>
            <li>Graphic design software (Adobe Photoshop, Illustrator)</li>
            <li>Creativity and artistic skills</li>
            <li>Typography and color theory</li>
            <li>Attention to detail</li>
            <li>Time management and project deadlines</li>
        </ul>

        <a href="graphics_designer_courses.php" class="btn-view-courses">View Courses</a>
    </div>
