...
<body>
    <div class="container form-container">
        <h1>API Specialist</h1>

        <h2>Job Responsibilities</h2>
        <ul>
            <li>Design and develop APIs for applications</li>
            <li>Ensure API security and performance</li>
            <li>Work with developers to integrate APIs</li>
            <li>Monitor API usage and troubleshoot issues</li>
            <li>Document API functionalities and specifications</li>
        </ul>

        <h2>Average Salary</h2>
        <p>$75,000 - $120,000 per year</p>

        <h2>Required Skills</h2>
        <ul>
            <li>RESTful and SOAP APIs</li>
            <li>JSON, XML, and HTTP protocols</li>
            <li>API authentication and security</li>
            <li>Backend programming (Node.js, Python, Java)</li>
            <li>API documentation tools (Swagger, Postman)</li>
        </ul>

        <a href="api_specialist_courses.php" class="btn-courses">View Courses</a>
    </div>
